        ...
        onFinish: function (data) {
            ...
            if ($("#dropdownShifts").val() == 2) {
                if (toVal != data.to) {
                    ...
                    if (true) {
                        // console.log("exp time:" + extendableTime() + ",toval2:" + toVal2);
                        console.log("=>" + fromVal2, checkInterval());
                        // s2.update({
                        //   // to: extendableTime() + toVal2,
                        //   from: fromVal2 - checkInterval(),
                        // });
                        updateSlider2(checkInterval());
                    }
                } else {
                    fromVal = data.from;
                    if (true) {
